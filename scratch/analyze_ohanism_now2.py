...
print(f"Fetching data for {wallet} (last 24h)...")
...
while True:
    ...
    print(f"Fetched {len(data)} items. Offset: {offset}. Last item TS: {last_ts}")
...
print('========================================')
print(f'ANÁLISIS DE WALLET: {wallet} (Últimas 24 hrs)')
print('========================================')
